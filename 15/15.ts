...
let guesthowcanotmakeit  :string = "Usman Khan"
console.log(guesthowcanotmakeit + "Can't make to dinner")

let new_Guest = "Babar Azam"
let indexOfguesthowcanotmakeit :number = guest__list.indexOf(guesthowcanotmakeit)
...
//#1
let newGuestatBeginning: string = "Muhammad Rizwan"
...
let newGuestInMiddle : string = "Muhammad Amir"
let midPoint: number = Math.floor(guest__list.length/2)
